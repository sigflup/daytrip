...
#define VDP_SET_REGISTER2(x,y) \
{ \
 address2 = (u16 *)VDP_CONTROL; \
 *address2 = (u16)(0x8000 | (x<<8)) | y; \
}



#define VDP_SET_INC(Q) \
 last_inc = Q; \
 VDP_SET_REGISTER(AUTO_INCREMENT, Q);
...
#define VDP_SET_PAL2(I,R,G,B) 	{\
 CRAM_WRITE2((I<<1),VDP_CRAM_COLOR(R,G,B))\
}
